...
class ParseResponse:
    ...
    Attributes:
        ...
        input_tokens (Union[Unset, int]): Number of input tokens consumed by LLM calls
        output_tokens (Union[Unset, int]): Number of output tokens generated by LLM calls
        total_tokens (Union[Unset, int]): Total tokens consumed (input + output)
    """
